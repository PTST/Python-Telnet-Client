...
class ExampleApp(QtGui.QMainWindow, design.Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.unitIP.setPlaceholderText("Enheds IP")
        self.RouterIP.setPlaceholderText("Router IP")
        self.rootPassword.setPlaceholderText("Root Password")
    ...
    def portset(self):
        ...
        print "Portforward sat til: " + portvalg
    ...
    def cpeconnect(self):
        ...
        if command == cnt:
            ...
            search2 = re.findall ( 'Channel(.*?)forced', line, re.DOTALL)
            print "Channel" + (search2[0]) + "forced"
